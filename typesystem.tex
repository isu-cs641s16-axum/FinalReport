...
%schema (s : schema\_ty): Type := & & \emph{Schema} \\
...
%%& \quad \mid t\_lrearrange: & id \rightarrow \:col \rightarrow \:tm\\
%%& \quad \mid t\_grearrange: & id \rightarrow \:col \rightarrow \:tm\\
%%& \quad \mid t\_package: & id \rightarrow \:col \rightarrow \:tm\\
